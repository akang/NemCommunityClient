...
import org.nem.ncc.model.MarketDepthQuotes;
import org.nem.ncc.model.OperatorOptions;
...
public class BrokerMapper
{
    ...
    public org.nem.ncc.model.MarketDepthQuotes toClientModel(final MarketDepthQuotes marketQuotes) {
        ...
        return new org.nem.ncc.model.MarketDepthQuotes(marketQuotes.getTradePair(), marketQuotes.getSellQuotes(), marketQuotes.getBuyQuotes());
    }
    ...
    public org.nem.ncc.model.OrderUpdate toClientModel(final OrderUpdate response) {
        ...
        return new org.nem.ncc.model.OrderUpdate(response.getOrder(), response.getMessage(), response.getReservedAmount());
    }
