'use strict';
define(['ncc', 'd3fc'], function(ncc, d3fc) {
    var container;
    ...
    fc.tooltip = function() {
        ...
        var items = [
            function(d) {
                return format('date', d.date);
            },
            function(d) {
                return 'High: ' + format('price', d.high);
            },
            function(d) {
                return 'Low: ' + format('price', d.low);
            },
            function(d) {
                return 'Volume: ' + format('volume', d.volume);
            },
            function(d) {
                return 'Open: ' + format('price', d.open);
            },
            function(d) {
                return 'Close: ' + format('price', d.close);
            }
        ];
    ...
    function setupChart(selector) {
        container = d3.select(selector);
        console.log(container);
    }

    function fillData(candlesticks) {
        var graphData = $.map(candlesticks, function(val) {
